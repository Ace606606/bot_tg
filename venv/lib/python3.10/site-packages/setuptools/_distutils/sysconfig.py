...
def customize_compiler(compiler):
    ...
    if compiler.compiler_type == "unix":
        if sys.platform == "darwin":
            ...
            # config_data vars on OS X now that we know we need a compiler.
...
_makefile_tmpl = 'config_data-{python_ver}{build_flags}{multiarch}'
...
def parse_config_h(fp, g=None):
    """Parse a config_data.h-style file.
